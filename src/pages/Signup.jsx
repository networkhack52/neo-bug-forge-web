...
const STYLES = `
  ...
  *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
  ...
  .success-box {
    ...
    color: #34d399; font-size: .9rem; text-align: center; line-height: 1.6;
  }
  .success-box strong { display: block; font-size: 1.1rem; margin-bottom: .35rem; }
  ...
  .terms-note { font-size: .78rem; color: var(--muted); text-align: center; margin-top: 1rem; line-height: 1.6; }
  .terms-note a { color: var(--muted2); }
`;
        ...
        <div className="auth-card">
          ...
          {sent ? (
            ...
            <>
              ...
              <p className="subtitle">Free plan includes 100 fixes/month. No credit card required.</p>
              ...
              <form onSubmit={handleSignup}>
                ...
                <div className="field">
                  ...
                  <input type="password" placeholder="Min. 8 characters" minLength={8} value={password} onChange={e => setPassword(e.target.value)} required />
                </div>
              ...
              <p className="terms-note">
                By signing up you agree to our <a href="https://neobugforge.io/terms.html" target="_blank">Terms of Service</a> and <a href="https://neobugforge.io/privacy.html" target="_blank">Privacy Policy</a>.
              </p>
            </>
          )}
