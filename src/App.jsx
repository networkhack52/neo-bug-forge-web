...
async function callClaude(code, errorMsg, language) {
  const prompt = `You are an expert software engineer and debugger specializing in ${language || "multiple languages"}.

A developer has submitted broken code and its error message.

Tasks:
1. Identify the root cause.
2. Fix the code without changing original intent.
3. Write a minimal unit test that would have caught this bug.
